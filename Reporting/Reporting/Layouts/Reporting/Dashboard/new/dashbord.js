...
$(document).ready(function () {
    ...
    function projectClick() {
        ...
        getContractData(contractID).done(function (c) {
            cont = JSON.parse(c.d)[0];
    ...
    function ejraRavandChart(type) {
        ...
        if (type == 'net')
            series = [{ field: 'Network', name: 'انجام شده', type: 'column' }, { field: 'NetworkV1', name: 'برنامه۱', type: 'column' }, { field: 'NetworkV2', name: 'برنامه۲', type: 'column', visible: false },
            { field: 'NetCum', name: 'انجام شده تجمعی', type: 'line', yAxis: 1 }, { field: 'NetworkCumV1', name: 'برنامه۱ تجمعی', type: 'line', yAxis: 1 }, { field: 'NetworkCumV2', name: 'برنامه۲ تجمعی', type: 'line', yAxis: 1, visible: false }];
        else if (type == 'dar')
            series = [{ field: 'Drainage', name: 'انجام شده', type: 'column' }, { field: 'DrainV1', name: 'برنامه۱', type: 'column' }, { field: 'DrainV2', name: 'برنامه۲', type: 'column', visible: false },
            { field: 'DrainCum', name: 'انجام شده تجمعی', type: 'line', yAxis: 1 }, { field: 'DrainCumV1', name: 'برنامه۱ تجمعی', type: 'line', yAxis: 1 }, { field: 'DrainCumV2', name: 'برنامه۲ تجمعی', type: 'line', yAxis: 1, visible: false }];
        else if (type == 'equ')
            series = [{ field: 'Equipped', name: 'انجام شده', type: 'column' }, { field: 'EquipV1', name: 'برنامه۱', type: 'column' }, { field: 'EquipV2', name: 'برنامه۲', type: 'column', visible: false },
            { field: 'EquipCum', name: 'انجام شده تجمعی', type: 'line', yAxis: 1 }, { field: 'EquipCumV1', name: 'برنامه۱ تجمعی', type: 'line', yAxis: 1 }, { field: 'EquipCumV2', name: 'برنامه۲ تجمعی', type: 'line', yAxis: 1, visible: false }];
    ...
    function ejraOperationChart() {
        if (cont) {
            ...
            for (var i = 0; i < execO.length; i++) {
                ...
                else if (a.OperationID == 6)// تحت فشار
                {
                    total6 = addCommas(a.FinalVolume, 0);
                    doit6 = addCommas(a.Constructed, 0);
                    left6 = addCommas(a.Left, 0);
                    doitP16 = addCommas(a.Constructed / a.FinalVolume * 100, 1);
                    leftP16 = addCommas(a.Left / a.FinalVolume * 100, 1);
                }
                else if (a.OperationID == 7)// تحت فشار
                {
            ...
            html += '<tr><td>سهم از کل</td><td>' + percentFromTotal1 + '</td><td>' + percentFromTotal2 + '</td><td>' + percentFromTotal3 + '</td><td>' + percentFromTotal4 + '</td><td>100</td><td>100</td></tr>';
    ...
    function tahvil(type) {
        ...
        o.series = [{ name: 'تحويل', type: 'column', data: [t_totalSpace, t_execSpace, t_readySpace, t_docSpace, t_deliverSpace, t_deliverRemovedSpace + t_deliverWithoutSpace, t_deliver2Space] }];
