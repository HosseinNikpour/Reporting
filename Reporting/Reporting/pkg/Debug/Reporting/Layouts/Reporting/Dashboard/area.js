...
$(document).ready(function () {
    ...
    function areaClick() {
        ...
        jQuery.when(getAreaReport(areaId),
        getExtendedData(areaID),getValuesChanges(areaID)).done(function (a,e,v) {
             area = JSON.parse(a[0].d)[0];
        ...
        getInvoiceData(areaID).done(function(e){
        ...
        getExecMonthlyData(areaID).done(function (e) {
            ...
            getTahvilData(areaID).done(function (e) {
        ...
        getExecOperaData(areaID).done(function (e) {
        ...
        getTahvilByYear(areaID).done(function (e) {
            tahY = JSON.parse(e.d);
